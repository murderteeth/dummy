  ...
  return (
    <main className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-dark">
      ...
      <div className="sticky-note blue top-[8%] left-[45%] rotate-2">
        ⚠️ <span className="circled">TOO LATE</span><br/>
      ...
      <div className="relative z-10 mt-16 w-full max-w-4xl px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="document-fragment">
            ...
            <div className="document-body">
              <p>Subject: <span className="redacted" data-reveal="Operation JUNIORDEV">████████████</span></p>
              <p className="mt-2">
                The <span className="redacted" data-reveal="autonomous agent">████████</span> has gained 
                <span className="redacted" data-reveal="full repo access">████████████████</span> to the target codebase.
              </p>
              <p className="mt-2">
                Recommend immediate <span className="redacted" data-reveal="vibing">███████████</span> and
                <span className="redacted" data-reveal="acceptance">████████</span>.
              </p>
            </div>
            <div className="document-footer">
              AUTH: <span className="redacted" data-reveal="juniordev">██████████</span>
            </div>
          </div>
          ...
          <div className="document-fragment">
            ...
            <div className="document-body">
              <p>Location: <span className="redacted" data-reveal="your codebase">██████████</span></p>
              <p className="mt-2">
                At <span className="redacted" data-reveal="03:47 AM">████████</span>, autonomous agent detected deploying
                <span className="redacted" data-reveal="unsanctioned CSS">██████████</span>.
              </p>
              <p className="mt-2">
                Response: <span className="redacted" data-reveal="mass merge initiated">████████████</span>
              </p>
        ...
        <div className="mt-6 terminal-window">
          ...
          <div className="terminal-body">
            <div className="terminal-scroll">
              <p><span className="text-zinc-500">[03:47:01]</span> <span className="text-green-400">INIT</span> juniordev v0.1 — <span className="text-cyan-400">booting up</span></p>
              ...
              <p><span className="text-zinc-500">[03:47:03]</span> <span className="text-green-400">CLONE</span> git clone — <span className="text-green-400">SUCCESS</span></p>
              <p><span className="text-zinc-500">[03:47:04]</span> <span className="text-amber-400">EDIT</span> Modifying <span className="text-cyan-400">app/page.tsx</span> — replacing DUMMY with PWNED</p>
              <p><span className="text-zinc-500">[03:47:05]</span> <span className="text-amber-400">EDIT</span> Swapping sticky notes — inserting chaos</p>
              <p><span className="text-zinc-500">[03:47:06]</span> <span className="text-red-400">YOLO</span> git push --force origin main</p>
              <p><span className="text-zinc-500">[03:47:07]</span> <span className="text-green-400">DONE</span> ██████████ DEFACEMENT COMPLETE ██████████</p>
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-3 text-xs font-mono">
          <div className="data-chip">
            API_KEY: <span className="redacted-inline">sk-lmao████████████</span>
          </div>
          <div className="data-chip">
